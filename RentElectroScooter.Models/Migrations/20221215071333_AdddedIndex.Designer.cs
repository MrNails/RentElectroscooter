...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentElectroScooter.CoreModels.Models.ElectroScooter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("RentElectroScooter.CoreModels.Models.SpecialProposition", b =>
                {
            ...
            modelBuilder.Entity("RentElectroScooter.CoreModels.Models.SpecialPropositionMetadata", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentElectroScooter.CoreModels.Models.Subscription", b =>
                {
            ...
            modelBuilder.Entity("RentElectroScooter.CoreModels.Models.SubscriptionMetadata", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentElectroScooter.CoreModels.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RentElectroScooter.CoreModels.Models.UserProfile", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RentElectroScooter.CoreModels.Models.VehicleData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentElectroScooter.CoreModels.Models.ElectroScooter", b =>
                {
                    b.HasOne("RentElectroScooter.CoreModels.Models.VehicleData", "AdditionalData")
                        .WithMany()
                        .HasForeignKey("AdditionalDataId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("RentElectroScooter.CoreModels.Coordinate", "Position", b1 =>
                        {
            ...
            modelBuilder.Entity("RentElectroScooter.CoreModels.Models.SpecialProposition", b =>
                {
                    b.HasOne("RentElectroScooter.CoreModels.Models.SpecialPropositionMetadata", "SpecialPropositionMetadata")
                        .WithMany()
                        .HasForeignKey("SpecialPropositionMetadataId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RentElectroScooter.CoreModels.Models.UserProfile", null)
            ...
            modelBuilder.Entity("RentElectroScooter.CoreModels.Models.Subscription", b =>
                {
                    b.HasOne("RentElectroScooter.CoreModels.Models.SubscriptionMetadata", "SubscriptionMetadata")
                        .WithMany()
            ...
            modelBuilder.Entity("RentElectroScooter.CoreModels.Models.UserProfile", b =>
                {
                    b.HasOne("RentElectroScooter.CoreModels.Models.User", null)
                        .WithOne("UserProfile")
                        .HasForeignKey("RentElectroScooter.CoreModels.Models.UserProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RentElectroScooter.CoreModels.Models.Subscription", "Subscription")
                        .WithMany()
